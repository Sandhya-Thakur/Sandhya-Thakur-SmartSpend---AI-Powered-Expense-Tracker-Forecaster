...
const ExpenseList: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-1 rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="flex items-center px-2 py-2 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
          >
      ...
      {/* Filter panel */}
      {showFilters && (
        <div className="mb-4 p-1 border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50 dark:bg-gray-700">
          <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Filter Expenses</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              ...
              <div className="flex space-x-1">
                <input
                  ...
                  className="flex-1 rounded-md border border-gray-300 dark:border-gray-600 py-1 px-1 text-sm dark:bg-gray-800 dark:text-white"
                  placeholder="From"
                />
                <input
                  type="date"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleFilterChange}
                className="w-full rounded-md border border-gray-300 dark:border-gray-600 py-1 px-1 text-sm dark:bg-gray-800 dark:text-white"
              >
          ...
          <div className="mt-2 flex justify-end">
            <button
              ...
              className="px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300"
            >
              Reset Filters
            </button>
          </div>
      ...
      {error && (
        <div className="mb-3 p-2 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-md">
          {error}
        </div>
      )}

      {isLoading ? (
        <div className="py-8 text-center text-gray-500 dark:text-gray-400">Loading expenses...</div>
      ) : expenses.length === 0 ? (
        ...
        <>
          <div className="mb-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md flex justify-between items-center">
